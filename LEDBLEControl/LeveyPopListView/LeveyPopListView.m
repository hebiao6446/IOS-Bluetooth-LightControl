...
{
    for(UIView *myview in [aView subviews])
    {
        if ([myview isKindOfClass:[LeveyPopListView class]]) {
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextSetShadowWithColor(ctx, CGSizeMake(0, 1), 0.5f, [UIColor grayColor].CGColor);
